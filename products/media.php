            ...
            <table class="table">
              <thead>
                <tr >
                  ...
                  <th class="text-center">Nom de la photo</th>
                  <th class="text-center" style="width: 20%;">type de photo</th>
                ...
                <td class="text-center">
                  <a href="../products/delete_media.php?id=<?php echo (int) $media_file['id'];?>" 
