...
<!--     *************************     -->
                ...
                <th class="text-center" style="width: 15%;"> Prix de revient </th>
                <th class="text-center" style="width: 15%;"> Prix de vente </th>
                <th class="text-center" style="width: 15%;"> Produit ajouté </th>
...
<!--     *************************     -->
           ...
           data-toggle="tooltip" title="Ajouter">
                    ...
                    <a href="../products/edit_product.php?id=<?php echo (int)$product['id'];?>" class="btn btn-info btn-xs" 
