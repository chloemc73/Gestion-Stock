	...
	if (empty($errors)) {
		...
		if ( ! find_by_name('customers', $c_name) ) {
			...
			if ($result && $db->affected_rows() === 1) {
				...
				$session->msg('d', 'Échec de l ajout !');
				redirect('../customers/customers.php', false);
			}
		} else {
			$session->msg('d', 'Client déjà ajouté !');
			redirect('../customers/customers.php', false);
		}
...
<!--     *************************     -->
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="customer-address" value="" placeholder="Adresse">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="customer-city" value="" placeholder="Ville">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="customer-region" value="" placeholder="État / Province / Région">
               </div>
              </div>
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="customer-postcode" value="" placeholder=" Code Postal">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
	  ...
	  <div class="pull-right">
               <button type="submit" name="add_customer" class="btn btn-info" style="background-color:rgb(255, 143, 99)"
               >Ajouter</button>
          </form>
         </div>
        </div>
