...
$page_title = 'Page de redirection';
...
<body onload="window.location = './users/index.php'">
<!-- Bouton de toggle dark mode - positionné en haut à gauche -->
...
<pre>Vous ne devriez pas être ici.</pre>
</body>
</html>
