    ...
    <form method="post" action="">
        <div class="form-group">
          <div class="input-group">
            ...
            <button type="submit" name="update_category" class="btn btn-primary" style="background-color:rgb(255, 143, 99)"
            >Modifier la categorie</button>
            </span>


                    <select class="form-control" name="product-category">
                      <option value="0">Selectionner une categorie de produit</option>
		    <?php
      ...
      <div class="panel-heading clearfix">
        <strong>
          ...
          <div class="pull-right">
            <a href="../sales/add_sale_by_search.php?id=<?php echo $order_id; ?>" 
            class="btn btn-success">Ajouter la vente par recherche</a>
          </div>
      </div>
