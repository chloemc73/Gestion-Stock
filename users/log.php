...
$page_title = 'Tous les journaux';
require_once '.././includes/load.php';
// Vérifier quel niveau d'utilisateur a la permission de voir cette pagee
...
<!--     *************************     -->
	...
	<th class="text-center" style="width: 15%;"> ID_utilisateur </th>
	<th class="text-center" style="width: 15%;"> ID_distant  </th>
